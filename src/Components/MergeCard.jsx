...
const MergeCard = () => {
  ...
  return (
    ...
    <div className="h-[375px] w-[360px] bg-white rounded-2xl shadow-md p-4 flex flex-col items-center
                    transition-transform duration-300 ease-in-out hover:scale-110 hover:shadow-xl cursor-pointer"
    ...
    {open && (
      <Modal onClose={() => setOpen(false)}>
        <h2 className="text-2xl font-bold mb-4">Merge Sort Visualizer</h2>
        <MergeSort/>
      </Modal>
    )}
    </>
